...
@section('konten')
        <form action="{{ route('kuisioner.store') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="row mb-3">
                <div class="col-md-6">
                    <label for="label" class="form-label">Nama Penyuluh</label>
            ...
            <div class="row mb-3">
                ...
                <div class="col-md-6">
                    <label for="" class="form-label">SK Pengukuhan</label>
                    <input type="file" name="sk_pengukuhan" id="sk_pengukuhan" class="form-control">
                </div>
            </div>
            <div class="row mb-3">
                <div class="col-md-6">
